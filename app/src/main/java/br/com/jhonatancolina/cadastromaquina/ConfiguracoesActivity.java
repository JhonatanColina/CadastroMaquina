...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    private AutoCompleteTextView etIdUsuarioDados,etNomeUsuarioDados,
            etNivelAdminDados,etSenhaDados,etRepetirSenhaDados;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        etNivelAdminDados = (AutoCompleteTextView) findViewById(R.id.etNivelAdminDados);
    ...
    {
        etIdUsuarioDados.setText(sr.getUsuario().getId());
        etNomeUsuarioDados.setText(sr.getUsuario().getUsuario());
        etNivelAdminDados.setText(sr.getUsuario().isAdmin()==true?getString(R.string.usuarioAdmin):getString(R.string.usuarioComum));
    }
        ...
        if(verificaCampos())
        {
            if(etSenhaDados.getText().toString().equals(etRepetirSenhaDados.getText().toString()))
            {
                ...
                Usuario u = new Usuario(etIdUsuarioDados.getText().toString(),
                        etNomeUsuarioDados.getText().toString(),etSenhaDados.getText().toString(),sr.getUsuario().isAdmin());
